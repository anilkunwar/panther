...
#include "SumThreeCdothsquare.h"

registerMooseObject("pantherApp", SumThreeCdothsquare);

template <>
InputParameters
validParams<SumThreeCdothsquare>()
{
  ...
  params.addRequiredParam<MaterialPropertyName>("h2_name","Switching function of ni");
...
SumThreeCdothsquare::SumThreeCdothsquare(const InputParameters & parameters)
...
Real
SumThreeCdothsquare::computeValue()
{
