...
HfsSumEtasnimc::HfsSumEtasnimc(const InputParameters & parameters)
...
HfsSumEtasnimc::computeValue()
{
  ...
  return _prop_h1[_qp]*_prop_h2[_qp]*(_var1[_qp]+_var2[_qp])+_prop_h3[_qp]*_prop_h3[_qp]*_prop_h3[_qp]*_var3[_qp] ;
}
