...
validParams<SumThreeEtasquare>()
{
  ...
  params.addRequiredCoupledVar("var3", "order parameter as coupled variable."); //var3=eta_imc3
  params.addRequiredCoupledVar("var4", "order parameter as coupled variable."); //var4=eta_ni
  params.addRequiredCoupledVar("var5", "order parameter as coupled variable."); //var5=eta_al
  params.addRequiredParam<MaterialPropertyName>("h123_name","Switching function of imc");
  params.addRequiredParam<MaterialPropertyName>("h4_name","Switching function of ni");
  params.addRequiredParam<MaterialPropertyName>("h5_name","Switching function of al");
...
SumThreeEtasquare::SumThreeEtasquare(const InputParameters & parameters)
  : AuxKernel(parameters),
    ...
    _prop_h123(getMaterialProperty<Real>("h123_name")),
...
Real
SumThreeEtasquare::computeValue()
{
