...
#include "HfsSumEtasquare.h"

registerMooseObject("pantherApp", HfsSumEtasquare);

template <>
InputParameters
validParams<HfsSumEtasquare>()
{
...
HfsSumEtasquare::HfsSumEtasquare(const InputParameters & parameters)
