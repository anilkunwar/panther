...
#include "HfsSumEtaimc.h"

registerMooseObject("pantherApp", HfsSumEtaimc);

template <>
InputParameters
validParams<HfsSumEtaimc>()
{
...
HfsSumEtaimc::HfsSumEtaimc(const InputParameters & parameters)
...
HfsSumEtaimc::computeValue()
{
  ...
  return _prop_h1[_qp]*_prop_h2[_qp]*(_var1[_qp]+_var2[_qp]) ;
}
