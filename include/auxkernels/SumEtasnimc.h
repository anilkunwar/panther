...
#ifndef SUMETASNIMC_H
#define SUMETASNIMC_H
...
template <>
InputParameters validParams<SumEtasnimc>();

/**
 * Auxiliary kernel responsible for computing the Darcy velocity given
 * several fluid properties and the pressure gradient.
 */
class SumEtasnimc : public AuxKernel
{
public:
  SumEtasnimc(const InputParameters & parameters);
