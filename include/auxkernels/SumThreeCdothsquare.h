...
#ifndef SUMTHREECDOTHSQUARE_H
#define SUMTHREECDOTHSQUARE_H

#include "AuxKernel.h"

// Forward Declarations
class SumThreeCdothsquare;

template <>
InputParameters validParams<SumThreeCdothsquare>();

/**
 * Auxiliary kernel responsible for computing the Darcy velocity given
 * several fluid properties and the pressure gradient.
 */
class SumThreeCdothsquare : public AuxKernel
{
public:
  SumThreeCdothsquare(const InputParameters & parameters);
