...
#ifndef HFSSUMETASQUARE_H
#define HFSSUMETASQUARE_H

#include "AuxKernel.h"

// Forward Declarations
class HfsSumEtasquare;

template <>
InputParameters validParams<HfsSumEtasquare>();

/**
 * Auxiliary kernel responsible for computing the Darcy velocity given
 * several fluid properties and the pressure gradient.
 */
class HfsSumEtasquare : public AuxKernel
{
public:
  HfsSumEtasquare(const InputParameters & parameters);
