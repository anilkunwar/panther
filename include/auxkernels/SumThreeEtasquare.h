...
#ifndef SUMTHREEETASQUARE_H
#define SUMTHREEETASQUARE_H

#include "AuxKernel.h"

// Forward Declarations
class SumThreeEtasquare;

template <>
InputParameters validParams<SumThreeEtasquare>();

/**
 * Auxiliary kernel responsible for computing the Darcy velocity given
 * several fluid properties and the pressure gradient.
 */
class SumThreeEtasquare : public AuxKernel
{
public:
  SumThreeEtasquare(const InputParameters & parameters);
