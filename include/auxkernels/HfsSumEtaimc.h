...
#ifndef HFSSUMETAIMC_H
#define HFSSUMETAIMC_H
...
template <>
InputParameters validParams<HfsSumEtaimc>();

/**
 * Auxiliary kernel responsible for computing the Darcy velocity given
 * several fluid properties and the pressure gradient.
 */
class HfsSumEtaimc : public AuxKernel
{
public:
  HfsSumEtaimc(const InputParameters & parameters);
