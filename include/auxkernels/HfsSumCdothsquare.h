...
#ifndef HFSSUMCDOTHSQUARE_H
#define HFSSUMCDOTHSQUARE_H

#include "AuxKernel.h"

// Forward Declarations
class HfsSumCdothsquare;

template <>
InputParameters validParams<HfsSumCdothsquare>();

/**
 * Auxiliary kernel responsible for computing the Darcy velocity given
 * several fluid properties and the pressure gradient.
 */
class HfsSumCdothsquare : public AuxKernel
{
public:
  HfsSumCdothsquare(const InputParameters & parameters);
