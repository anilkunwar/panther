...
#ifndef HFSSUMETASNIMC_H
#define HFSSUMETASNIMC_H

#include "AuxKernel.h"

// Forward Declarations
class HfsSumEtasnimc;

template <>
InputParameters validParams<HfsSumEtasnimc>();

/**
 * Auxiliary kernel responsible for computing the Darcy velocity given
 * several fluid properties and the pressure gradient.
 */
class HfsSumEtasnimc : public AuxKernel
{
public:
  HfsSumEtasnimc(const InputParameters & parameters);
