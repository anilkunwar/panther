...
#ifndef SUMCDOTHSQUARE_H
#define SUMCDOTHSQUARE_H

#include "AuxKernel.h"

// Forward Declarations
class SumCdothsquare;

template <>
InputParameters validParams<SumCdothsquare>();

/**
 * Auxiliary kernel responsible for computing the Darcy velocity given
 * several fluid properties and the pressure gradient.
 */
class SumCdothsquare : public AuxKernel
{
public:
  SumCdothsquare(const InputParameters & parameters);
